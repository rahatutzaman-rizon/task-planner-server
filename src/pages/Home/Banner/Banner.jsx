    ...
    return (
        <div className="-mt-28">
            <div className="relative">
                <img className="w-full relative object-cover xl:h-[400px]" src="https://i.ibb.co/nspC8Hn/task.jpg" alt="" />
                <div className='absolute top-0 bg-gradient-to-r from-[#301540] to-[#402540] w-full h-full text-white'>
                    <motion.div initial={{ y: -150 }} animate={{ y: 0 }} transition={{ duration: "2", delay: "0" }} className='absolute right-28 left-16 md:left-24 2xl:left-60 space-y-1 md:space-y-3 lg:space-y-5 top-32 md:top-44 lg:top-56 xl:top-96'>
                        ...
                        <div>
                            <Link to="/dashboard"><button className="md:py-2 md:px-3 py-1 px-3 rounded hover:bg-white hover:text-black border lg:px-5 text-xs text-white md:text-sm lg:text-base lg:py-3 font-semibold">Let's Explore the task Planner</button></Link>
                        </div>
                    </motion.div>
                </div>
            </div>
